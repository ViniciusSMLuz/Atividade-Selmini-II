...
public class Exercício2 {
    ...
    public static void main(String[] args) {
        ...
        imprimir(numeros, 10);
        System.out.println("Ordenando os números crescentemente:");
        ordenar(numeros, 10);
        imprimir(numeros, 10);
        System.out.println("Informe um valor qualquer que você queira puxar do quadro, note que ele pode ou não estar la!:");
        int val = teclado.nextInt();
        System.out.println("Para True, seu número está dentro do quadro, para False, ele não foi encontrado --> " + acharposicao(numeros, val));
